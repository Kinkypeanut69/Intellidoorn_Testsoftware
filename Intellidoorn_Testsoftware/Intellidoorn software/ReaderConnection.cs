...
namespace Intellidoorn_software
{
    class ReaderConnection
    {
        ...
        public ReaderConnection()
        {
            ...
            Stand a1 = new Stand("100000000000000000000103", "100000000000000000000112", "100000000000000000000126", "100000000000000000000127", "A", 1.30, 0.00, 1);
            Stand a2 = new Stand("100000000000000000000112", "100000000000000000000103", "100000000000000000000118", "100000000000000000000123", "A", 1.00, 1.30, 2);
            Stand a3 = new Stand("100000000000000000000123", "100000000000000000000118", "100000000000000000000113", "100000000000000000000102", "A", 1.00, 2.35, 3);
            Stand a4 = new Stand("100000000000000000000102", "100000000000000000000113", "100000000000000000000130", "100000000000000000000130", "A", 1.00, 3.35, 4);

            Stand b1 = new Stand("100000000000000000000106", "100000000000000000000115", "100000000000000000000128", "100000000000000000000129", "B", 1.30, 0.00, 1);
            Stand b2 = new Stand("100000000000000000000106", "100000000000000000000115", "100000000000000000000116", "100000000000000000000121", "B", 1.00, 1.30, 2);
            Stand b3 = new Stand("100000000000000000000109", "100000000000000000000116", "100000000000000000000121", "100000000000000000000114", "B", 1.00, 2.35, 3);
            Stand b4 = new Stand("100000000000000000000109", "100000000000000000000114", "100000000000000000000130", "100000000000000000000130", "B", 1.00, 3.35, 4);

            Stand c1 = new Stand("100000000000000000000110", "100000000000000000000130", "100000000000000000000130", "100000000000000000000130", "C", 1.30, 0.00, 1);
            Stand c2 = new Stand("100000000000000000000110", "100000000000000000000117", "100000000000000000000130", "100000000000000000000130", "C", 1.00, 1.30, 2);
            Stand c3 = new Stand("100000000000000000000117", "100000000000000000000107", "100000000000000000000130", "100000000000000000000130", "C", 1.00, 2.35, 3);
            Stand c4 = new Stand("100000000000000000000107", "100000000000000000000130", "100000000000000000000130", "100000000000000000000130", "C", 1.00, 3.35, 4);
